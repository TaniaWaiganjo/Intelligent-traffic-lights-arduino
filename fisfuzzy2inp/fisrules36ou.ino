...
// Rule Weights
FIS_TYPE fis_gRWeight[] = { 0.7, 0.7, 0.7, 0.7, 0.7, 0.8, 0.7, 0.9, 1, 0.7, 0.7, 0.7, 0.7, 0.7, 0.8, 0.7, 0.9, 1, 0.7, 0.7, 0.7, 0.7, 0.7, 0.8, 0.7, 0.9, 1, 0.7, 0.7, 0.7, 0.7, 0.7, 0.8, 0.7, 0.9, 1 };
...
int fis_gRI18[] = { 0, 0, 0, 0, 1, 1, 0, 0 };
int fis_gRI19[] = { 0, 0, 0, 0, 2, 1, 0, 0 };
int fis_gRI20[] = { 0, 0, 0, 0, 3, 1, 0, 0 };
int fis_gRI21[] = { 0, 0, 0, 0, 1, 2, 0, 0 };
int fis_gRI22[] = { 0, 0, 0, 0, 2, 2, 0, 0 };
int fis_gRI23[] = { 0, 0, 0, 0, 3, 2, 0, 0 };
int fis_gRI24[] = { 0, 0, 0, 0, 1, 3, 0, 0 };
int fis_gRI25[] = { 0, 0, 0, 0, 2, 3, 0, 0 };
int fis_gRI26[] = { 0, 0, 0, 0, 3, 3, 0, 0 };
int fis_gRI27[] = { 0, 0, 0, 0, 0, 0, 1, 1 };
int fis_gRI28[] = { 0, 0, 0, 0, 0, 0, 2, 1 };
int fis_gRI29[] = { 0, 0, 0, 0, 0, 0, 3, 1 };
int fis_gRI30[] = { 0, 0, 0, 0, 0, 0, 1, 2 };
int fis_gRI31[] = { 0, 0, 0, 0, 0, 0, 2, 2 };
int fis_gRI32[] = { 0, 0, 0, 0, 0, 0, 3, 2 };
int fis_gRI33[] = { 0, 0, 0, 0, 0, 0, 1, 3 };
int fis_gRI34[] = { 0, 0, 0, 0, 0, 0, 2, 3 };
int fis_gRI35[] = { 0, 0, 0, 0, 0, 0, 3, 3 };
