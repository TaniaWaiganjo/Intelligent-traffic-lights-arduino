...
void loop() {
  // Assign new random numbers to any display that has reached 0
  if (number1 == 0) number1 = random(200);
  if (number2 == 0) number2 = random(200);
  if (number3 == 0) number3 = random(200);
  if (number4 == 0) number4 = random(200);
